...
openssl req -newkey rsa:4096 -nodes -keyout server-key.pem -out server-cert.pem -subj "/C=BR/ST=Sao Paulo/L=Sao Paulo/O=Office/OU=Computer/CN=*.tec1.com/emailAddress=silas1@tec1.com"
