...
type ProductServiceClient interface {
	FindAll(ctx context.Context, in *ListProductListRequest, opts ...grpc.CallOption) (*ProductListResponse, error)
}
...
func (c *productServiceClient) FindAll(ctx context.Context, in *ListProductListRequest, opts ...grpc.CallOption) (*ProductListResponse, error) {
...
type ProductServiceServer interface {
	FindAll(context.Context, *ListProductListRequest) (*ProductListResponse, error)
...
func (UnimplementedProductServiceServer) FindAll(context.Context, *ListProductListRequest) (*ProductListResponse, error) {
...
func _ProductService_FindAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).FindAll(ctx, req.(*ListProductListRequest))
	}
